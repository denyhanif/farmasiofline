<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="FormPatientHistoryLite.aspx.cs" Inherits="Form_FormPatientHistoryLite" %>
            ...
            <ContentTemplate>
                ...
                <div>
                    <div runat="server" id="searchSection" class="row"  style="margin-top:-7% ; margin-right:-12%; position:absolute; width:100%; margin-bottom:10%" visible="true">
                        <div class="col-sm-3" style="background-color:white;height: 57px;padding-top: 15px;padding-left: 30px;margin-top:-1%;border-bottom-color: #CDCED9;border-bottom-width:thin;border-bottom-style:solid">
                        ...
                        <div class="col-sm-9" style="background-color:white;height: 57px;padding-left: 30px;margin-top:-1%;border-color:lightgray;border-style:dashed;border-width:thin;border-top: none;border-bottom-color: #CDCED9;border-bottom-width:thin;border-bottom-style:solid">
                            <div style="padding-top:5px">
                                <div class="row">
                ...
                <div runat="server" id="divFrame" style="margin-top:8%">
                    <iframe name="myIframe" id="myIframe" runat=server style="width:100%; height: calc(100vh - 90px); border:none; margin-top:-5%; overflow-y:auto"></iframe>
                </div>                
                <%--====================================================CONTENT END===================================================--%>

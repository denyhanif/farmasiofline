...
public partial class Form_FormPrintLabOrder : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            HyperLink test = Master.FindControl("HyperLink4") as HyperLink;
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            long OrgId = long.Parse(Session[Helper.SessionOrganization].ToString());
            string url = "~/Form/LabOrder.aspx?OrgId=" + OrgId + "&MrNo="+txtMRno.Text + "&PrintBy=" + Session["sessionPharmacistFullName"].ToString();
            myIframe.Src = url;
        }
        showHeader();
        updateBIG.Update();

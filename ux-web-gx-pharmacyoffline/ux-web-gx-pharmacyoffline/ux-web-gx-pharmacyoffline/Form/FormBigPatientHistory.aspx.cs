...
public partial class Form_FormBigPatientHistory : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            HyperLink test = Master.FindControl("HyperLink5") as HyperLink;
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            string url = "~/Form/BigPatientHistory.aspx?idPatient=" + patientId + "&OrgId=" + Session["listOrganization"] + "&PrintBy=" + Session["sessionPharmacistFullName"] + "&FlgCmpnd=" + "FALSE";

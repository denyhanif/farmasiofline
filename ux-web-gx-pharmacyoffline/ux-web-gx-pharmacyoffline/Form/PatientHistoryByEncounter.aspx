<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PatientHistoryByEncounter.aspx.cs" Inherits="Form_PatientHistoryByEncounter" %>
            ...
            <asp:UpdatePanel runat="server">
                <ContentTemplate>
                    <div class="row" style="background-color: #f4f4f4;margin-top:-16px">
                        ...
                        <div class="col-sm-7" style="padding-left:0px;margin-right:-8%; padding-top: 5px; padding-bottom: 8px;">
                            ...
                            <div class="btn-group btn-group-justified" role="group" style="width: 95%;font-family:Arial, Helvetica, sans-serif;font-size:12px" aria-label="...">
                                <div class="btn-group" role="group" style="width: 14%; vertical-align: top">
                                    ...
                                    <b><asp:Label CssClass="form-group" runat="server" ID="localMrNo"></asp:Label></b>
                                    &nbsp;
                                    <asp:Label CssClass="form-group" runat="server">/</asp:Label>
                                    &nbsp;
                                    <asp:Label CssClass="form-group" runat="server">DOB:</asp:Label>
                                    <b><asp:Label CssClass="form-group" runat="server" ID="lblDOB"></asp:Label></b>
                                    &nbsp;
                                    <asp:Label CssClass="form-group" runat="server">/</asp:Label>
                                    &nbsp;
                                    <asp:Label CssClass="form-group" runat="server">Age:</asp:Label>
                                    <b><asp:Label CssClass="form-group" runat="server" ID="lblAge"></asp:Label></b>
                                    &nbsp;
                                    <asp:Label CssClass="form-group" runat="server">/</asp:Label>
                                    &nbsp;
                                    <asp:Label CssClass="form-group" runat="server">Religion:</asp:Label>
                                    <b><asp:Label CssClass="form-group" runat="server" ID="lblReligion"></asp:Label></b>
                                </div>
                            </div>
                        </div>

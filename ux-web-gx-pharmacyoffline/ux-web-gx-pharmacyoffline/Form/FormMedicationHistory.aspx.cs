...
public partial class Form_FormMedicationHistory : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            HyperLink test = Master.FindControl("HyperLink3") as HyperLink;
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            string url = "~/Form/MedicationHistory.aspx?PatientId=" + patientId;

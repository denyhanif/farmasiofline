<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="FormBigPatientHistory.aspx.cs" Inherits="Form_FormBigPatientHistory" %>
        ...
        <asp:UpdatePanel runat="server" ID="updateBIG" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div runat="server" id="divFrame" style="margin-top:8%">
                    <iframe name="myIframe" id="myIframe" runat=server style="width:100%; height: calc(100vh - 90px); border:none; margin-top:-4%; overflow-y:auto"></iframe>
                </div>                
                <%--====================================================CONTENT END===================================================--%>
